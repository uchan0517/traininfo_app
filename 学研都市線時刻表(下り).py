...
for r in range(2):
    if r == 0:
        res=requests.get(f'https://timetable.jr-odekake.net/station-timetable/2890067002?date={today}')
    else:
        res=requests.get(f'https://timetable.jr-odekake.net/station-timetable/2890067002?date={tomorrow}')
